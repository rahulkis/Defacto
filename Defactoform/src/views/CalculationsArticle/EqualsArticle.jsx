...
class EqualsArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "equals" };
  }
  ...
  render() {
    return (
      <div>
        <h3>Equals == </h3>
        <p>
          The equals sign returns true when the values before and after it are
          the same. Note that the type of data is important.
        </p>
