...
export default class DateIsFutureArticle extends React.Component {
  constructor(props) {
    super(props);
    this.state = { copyFormulaName: "dateisfuture" };
  }
  ...
  render() {
    return (
      <div>
        <h3>DATEISFUTURE( date, format )</h3>
        <div className="CalculationsHelp__formulaHelp">
          Check is a date is in the future.
          <p>The DATEISFUTURE function accepts these arguments:</p>
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="764gg-0-0">
                            <span data-text="true">DATEISFUTURE</span>
                          </span>
                        </span>
