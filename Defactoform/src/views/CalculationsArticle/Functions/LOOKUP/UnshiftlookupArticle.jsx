...
class UnshiftlookupArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "unshiftlookup" };
  }
  ...
  render() {
    return (
      <div>
        <h3>UNSHIFT(array, value, valueN)</h3>
        <div className="CalculationsHelp__formulaHelp">
          Returns a new array with the provided value (or multiple values) added
          to the beginning.
          <p>The UNSHIFT function accepts these arguments:</p>
        ...
        <div style={{ position: "relative" }}>
          <a
            ...
            onClick={() =>
              this.copyformula(
                'UNSHIFT(ARRAY(1,2,3), "Monkeys")',
                this.state.copyFormulaName,
                '// returns ["Monkeys", 1, 2, 3] ',
                '["Monkeys", 1, 2, 3]'
              )
            }
          >
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="fmqs9-0-0">
                            <span data-text="true">UNSHIFT</span>
                          </span>
                        </span>
                        ...
                        <span className="prism-token token string">
                          <span data-offset-key="cjvtq-12-0">
                            <span data-text="true">"Monkeys"</span>
                          </span>
                        </span>
                        <span className="prism-token token punctuation">
...
export default UnshiftlookupArticle;
