...
class UpperTextArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "uppertext" };
  }
    ...
    return (
      <div>
        ...
        <div className="CalculationsHelp__formulaHelp">
          ...
          <p>The UPPER function accepts these arguments:</p>
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="66nrk-0-0">
                            <span data-text="true">UPPER</span>
                          </span>
                        </span>
                        ...
                        <span className="prism-token token comment">
                          <span data-offset-key="66nrk-11-0">
                            <span data-text="true">"// returns "TEXT""</span>
                          </span>
                        </span>
                      </div>
                    </div>
...
export default UpperTextArticle;
