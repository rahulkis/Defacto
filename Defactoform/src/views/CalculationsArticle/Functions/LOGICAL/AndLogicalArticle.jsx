...
class AndLogicalArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "andlogical" };
  }
  ...
  render() {
    return (
      <div>
        <h3>AND(value_1, value_2, . . .)</h3>
        <div className="CalculationsHelp__formulaHelp">
          Returns true if all the values are true.
          <p>The AND function accepts these arguments:</p>
...
export default AndLogicalArticle;
