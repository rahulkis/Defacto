...
class MedianStatisticalArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "medianstatistical" };
  }
  ...
  render() {
    return (
      <div>
        <h3>MEDIAN(number_1, number_2, . . .)</h3>
        <div className="CalculationsHelp__formulaHelp">
          Returns the median of a list of numbers. If there is an even number of
          arguments returns that average of the middle two.
          <p>The MEDIAN function accepts these arguments:</p>
              ...
              <table class="ResultsTable CalculationsHelp__formulaHelp table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>No</td>
                    <td>any</td>
                    <td>the numbers to find the median from</td>
                  </tr>
                </tbody>
              </table>
            </div>
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="8gjuf-0-0">
                            <span data-text="true">MEDIAN</span>
                          </span>
                        </span>
                  ...
                  <div data-contents="true">
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="prism-token token comment">
                          <span data-offset-key="8gjuf-20-0">
                            <span data-text="true">"// returns 17.5"</span>
                          </span>
                        </span>
                      </div>
                    </div>
...
export default MedianStatisticalArticle;
