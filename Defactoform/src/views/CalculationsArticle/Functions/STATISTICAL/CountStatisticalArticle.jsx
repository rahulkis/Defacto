...
class CountStatisticalArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "countstatistical" };
  }
    ...
    return (
      <div>
        ...
        <div className="CalculationsHelp__formulaHelp">
          ...
          <p>The COUNT function accepts these arguments:</p>
        ...
        <div style={{ position: "relative" }}>
          <a
            ...
            onClick={() =>
              this.copyformula(
                'COUNT(ARGS2ARRAY(1, 3, "pear", "5", "pear"))',
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="8gjuf-0-0">
                            <span data-text="true">COUNT</span>
                          </span>
                        </span>
                        ...
                        <span className="prism-token token comment">
                          <span data-offset-key="8gjuf-20-0">
                            <span data-text="true">"// returns 5"</span>
                          </span>
                        </span>
                      </div>
                    </div>
...
export default CountStatisticalArticle;
