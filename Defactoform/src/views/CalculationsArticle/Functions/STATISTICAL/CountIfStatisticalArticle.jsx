...
class CountIfStatisticalArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "countifstatistical" };
  }
  ...
  render() {
    return (
      <div>
        <h3>COUNTIF(values, criteria)</h3>
        <div className="CalculationsHelp__formulaHelp">
          Counts the number of values in an array that meet the criteria.
          <p>The COUNTIF function accepts these arguments:</p>
              ...
              <table class="ResultsTable CalculationsHelp__formulaHelp table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>No</td>
                    <td>any</td>
                    <td>the criteria to check against</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div style={{ position: "relative" }}>
          <a
            ...
            onClick={() =>
              this.copyformula(
                'COUNTIF(ARGS2ARRAY(1, 3, "pear", "5", "pear"), "pear")',
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="8gjuf-0-0">
                            <span data-text="true">COUNTIF</span>
                          </span>
                        </span>
...
export default CountIfStatisticalArticle;
