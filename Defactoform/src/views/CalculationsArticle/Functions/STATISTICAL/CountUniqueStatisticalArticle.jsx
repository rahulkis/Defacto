...
class CountUniqueStatisticalArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "countuniquestatistical" };
  }
  ...
  render() {
    return (
      <div>
        <h3>COUNTUNIQUE(values)</h3>
        <div className="CalculationsHelp__formulaHelp">
          Counts the number of unique values in an array.
          <p>The COUNTUNIQUE function accepts these arguments:</p>
        ...
        <div style={{ position: "relative" }}>
          <a
            ...
            onClick={() =>
              this.copyformula(
                'COUNTUNIQUE(ARGS2ARRAY(1, 1, 3, "banana", 3))',
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="8gjuf-0-0">
                            <span data-text="true">COUNTUNIQUE</span>
                          </span>
                        </span>
                        ...
                        <span className="prism-token token string">
                          <span data-offset-key="8gjuf-13-0">
                            <span data-text="true">"banana"</span>
                          </span>
                        </span>
                        <span className="prism-token token punctuation">
...
export default CountUniqueStatisticalArticle;
