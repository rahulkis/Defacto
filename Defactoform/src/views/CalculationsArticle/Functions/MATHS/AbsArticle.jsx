...
class AbsArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "abs" };
  }
    ...
    return (
      <div>
        ...
        <div className="CalculationsHelp__formulaHelp">
          ...
          <p>The ABS function accepts these arguments:</p>
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="prism-token token operator">
                          <span data-offset-key="dkfnc-2-0">
                            <span data-text="true">-</span>
                          </span>
                        </span>
