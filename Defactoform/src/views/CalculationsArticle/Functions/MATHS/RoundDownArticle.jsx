...
class RoundDownArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "rounddown" };
  }
  ...
  render() {
    return (
      <div>
        <h3>ROUNDDOWN(number, precision)</h3>
        <div className="CalculationsHelp__formulaHelp">
          Behaves the same as round but always rounds down.
          <p>The ROUNDDOWN function accepts these arguments:</p>
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="b02ej-0-0">
                            <span data-text="true">ROUNDDOWN</span>
                          </span>
                        </span>
                        ...
                        <span className="prism-token token comment">
                          <span data-offset-key="b02ej-8-0">
                            <span data-text="true">"// returns 3.64"</span>
                          </span>
                        </span>
                      </div>
                    </div>
...
export default RoundDownArticle;
