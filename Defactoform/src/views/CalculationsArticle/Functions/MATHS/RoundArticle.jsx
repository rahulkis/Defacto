...
class RoundArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "round" };
  }
  ...
  render() {
    return (
      <div>
        <h3>ROUND(number, precision)</h3>
        <div className="CalculationsHelp__formulaHelp">
          Rounds a number to the specified precision.
          <p>The ROUND function accepts these arguments:</p>
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="b02ej-0-0">
                            <span data-text="true">ROUND</span>
                          </span>
                        </span>
