...
class IsEvenArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "iseven" };
  }
    ...
    return (
      <div>
        ...
        <div className="CalculationsHelp__formulaHelp">
          ...
          <p>The ISEVEN function accepts these arguments:</p>
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="enloq-0-0">
                            <span data-text="true">ISEVEN</span>
                          </span>
                        </span>
