...
class IsTextArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "istext" };
  }
    ...
    return (
      <div>
        ...
        <div className="CalculationsHelp__formulaHelp">
          ...
          <p>The ISTEXT function accepts these arguments:</p>
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="enloq-0-0">
                            <span data-text="true">ISTEXT</span>
                          </span>
                        </span>
