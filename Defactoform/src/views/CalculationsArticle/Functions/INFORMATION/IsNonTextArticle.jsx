...
class IsNonTextArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "isnontext" };
  }
  ...
  render() {
    return (
      <div>
        <h3>ISNONTEXT(value)</h3>
        <div className="CalculationsHelp__formulaHelp">
          Returns true if the value is not text.
          <p>The ISNONTEXT function accepts these arguments:</p>
                      ...
                      >
                        <span className="prism-token token constant">
                          <span data-offset-key="enloq-0-0">
                            <span data-text="true">ISNONTEXT</span>
                          </span>
                        </span>
...
export default IsNonTextArticle;
