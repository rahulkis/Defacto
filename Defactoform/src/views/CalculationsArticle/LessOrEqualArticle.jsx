...
class LessOrEqualArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "lessorequal" };
  }
  ...
  render() {
    return (
      <div>
        <h3>Less or equal {"<="} </h3>
        <p>
          Returns true when the value on the left is smaller or equal to the
          value on the right.
        </p>
...
export default LessOrEqualArticle;
