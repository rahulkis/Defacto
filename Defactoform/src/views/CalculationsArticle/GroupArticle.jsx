...
class GroupArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyData: "(2 + 3) / 5", copyFormulaName: "group" };
  }
  ...
  render() {
    return (
      <div>
        <h3>Group ()</h3>
        <p>
          If you need to control the order in which operations are applied, you
          can use brackets () to group together expressions.This works for text
          expressions as well!
        </p>
                      ...
                      >
                        <span className="prism-token token number">
                          <span data-offset-key="8dmub-0-0">
                            <span data-text="true">(2 + 3) / 5</span>
                          </span>
                        </span>
                      </div>
                    </div>
