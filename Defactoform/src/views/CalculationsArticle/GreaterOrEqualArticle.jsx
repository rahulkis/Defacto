...
class GreaterOrEqualArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "greaterorequal" };
  }
  ...
  render() {
    return (
      <div>
        ...
        <p>
          Returns true when the value on the left is larger or equal to the
          value on the right.
        </p>
...
export default GreaterOrEqualArticle;
