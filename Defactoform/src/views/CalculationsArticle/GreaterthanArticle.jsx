...
class GreaterthanArticle extends React.Component {
  constructor() {
    super();
    this.state = { copyFormulaName: "greaterthan" };
  }
  ...
  render() {
    return (
      <div>
        <h3>Greater than > </h3>
        <p>
          Returns true when the value on the left is larger than the value on
          the right.
        </p>
...
export default GreaterthanArticle;
