...
export function getSelectionCoords(editor, toolbar) {
  ...
  let offsetTop = rangeBounds.top - editorBounds.top + 70;
  arrowStyle.top = "-17px";
  if (offsetTop - minOffsetTop - toolbarHeight + editorBounds.top < 0) {
    ...
    if (rangeBounds.bottom && !Number.isNaN(rangeBounds.bottom)) {
      offsetTop = rangeBounds.bottom - editorBounds.top + toolbarHeight - 20;
      arrowStyle.top = "20px";
      arrowStyle.transform = "rotate(180deg)";
    }
  }
  return { offsetLeft, offsetTop, minOffsetBottom,arrowStyle };
}
