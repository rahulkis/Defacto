    ...
    return (
      <li key={item.type} className="sidemenu__item">
        <Button
          ...
          editorState={this.props.editorState}
          onChange={this.onChange}
          groupCounter={this.props.groupCounter}
        />
      </li>
    );
  }
      ...
      <li className={className}>
        ...
        {!this.props.editorStartTyping && (
          <BlockStyles
            ...
            modalOptions={this.props.modalOptions}
            groupCounter={this.props.groupCounter}
            multipleChoiceArray={this.props.multipleChoiceArray}
          />
        )}
      </li>
    );
...
export default class SideBar extends Component {
  constructor(props) {
    super(props);
    this.state = { top: 0, groupCounter: 1, multipleChoiceArray: [] };
    this.onChange = this.onChange.bind(this);
  }
  ...
  onChange(editorState) {
    this.setState({ groupCounter: this.state.groupCounter + 1 });
    this.props.onChange(editorState);
  }
        ...
        <div style={{ top: `${this.state.top}px` }} className="sidebar__menu">
          <ul className="sidebar__sidemenu-wrapper">
            <SideMenu
              ...
              editorStartTyping={this.props.editorStartTyping}
              hideSidebarOnBlur={this.props.hideSidebarOnBlur}
              modalOptions={this.props.modalOptions}
