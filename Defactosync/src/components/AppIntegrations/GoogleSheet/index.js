...
import { AUTH_INTEGRATION, GOOGLE_SHEET_AUTH_URLS,GOOGLE_CREDENTIALS } from "constants/IntegrationConstant";
...
class GoogleSheet extends Component {
  ...
  componentDidMount() {
    ...
    document.getElementById("GoogleSheetDivId").click();
    }
  }
  ...
  addAuthAccnt = (res,tokenInfo,cliType,apiName) => {
    ...
    let formModel = {      
      ...
      tokenInfo:tokenInfo,
      apiName:apiName,
      endPoint:GOOGLE_SHEET_AUTH_URLS.BASE_URL,
    ...
    return (
      <>
        ...
        onClose={this.props.onClose}
          url={GOOGLE_SHEET_AUTH_URLS.AUTH_URL.replace(
            "{CLIENT_ID}",
