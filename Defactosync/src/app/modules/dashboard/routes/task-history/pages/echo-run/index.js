            ...
            {echo !== null && (
              <>
                <div className="ml-2 mt-3">
                  {moment.unix(echo.lastLiveAt).format("LL")}
                </div>
                <div className="ml-2">
              ...
              nodes.map((node) => (
                <div className="card">
                  <div className="card-header">
                    ...
                    <div style={{ marginLeft: "65px" }}>{moment.unix(echo.lastLiveAt).format("LLL")} - <Link to={"/editor/setup/" + echo.id}>Edit This Step</Link></div>
                  </div>
