...
import {
    APP_IMAGE_URL,
    IMAGE_FOLDER,
    CALENDLY_WEBHOOK_URLS,
} from "constants/AppConst";

class CalendlyTriggerTest extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            anchorEl: undefined,
    ...
    componentDidMount() {
        ...
        if (item.isConnectionTested) {
            try {
                ...
                httpClient
                    .post(CALENDLY_WEBHOOK_URLS.GET_RESPONSE_BY_NODE_ID, body)
                    .then((res) => {
    ...
    handleTestTrigger = () => {        
        ...
        if (item) {
            ...
            try {
                httpClient
                    .post(CALENDLY_WEBHOOK_URLS.GET_RESPONSE, body)
                    .then((res) => {                       
                        if (res.data.statusCode === 200) {
                ...
                {!nodeItem.isConnectionTested && !isTested && !isTestInfo && (
                    <div className="text-center">
                        ...
                        <div className="mt-2 info-text">
                            <p>
                                We'll find a recent message posted in your Calendly account
