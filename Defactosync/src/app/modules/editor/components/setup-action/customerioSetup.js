...
class CustomerioSetup extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
          ...
          {fields.map((field) => (
            <>
              {(field.key === "id" ||
                ...
                field.key === "last_name" ||
                field.key === "anonymous_id" ||
                field.key === "anonymous_event_name" ||
                field.key === "event_name" ||
                field.key === "data1_key" ||
                field.key === "data1_value" ||
                field.key === "data2_key" ||
                field.key === "data2_value") && (
...
export default CustomerioSetup;
